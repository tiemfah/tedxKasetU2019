    ...
    <div style={{ background: "white" }}>
      ...
      <ul className="c-faqs">
        <li className="c-faq c-faq--active">
          <span className="c-faq__title">KUY</span>
          <div className="c-faq__answer">KUY</div>
        </li>
        <li className="c-faq">
          <span className="c-faq__title">FUCK</span>
          <div className="c-faq__answer">FUCK</div>
        </li>
        <li className="c-faq">
          <span className="c-faq__title">SHIT</span>
          <div className="c-faq__answer">SHIT</div>
        </li>
      </ul>
